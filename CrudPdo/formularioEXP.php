    ...
    <div class="row">
        <div class="col-md-12">
            <div class="well well-sm">
                <form class="form-horizontal" method="POST" action="insertarPDOEXP.php">
                        <fieldset>
                        ...
                        <form action="editarPDOEXP.php" method="POST">
                                <div class="form-group">
                                    <button type="submit" value="Actualizar"  class="btn btn-success" >Editar</button>
                                    <input  name="datoactualiza" type="text"  placeholder="Digite la cedula que desea editar..." class="form-control">
                                </div>
                        </form>
                        ...
                        <form action="eliminarPDOEXP.php" method="POST">
                                <div class="form-group">
                                    <button type="submit" value="Eliminar"  class="btn btn-success" >Eliminar</button>
                                    <input  name="datoborra" type="text"  placeholder="Digite la cedula que desea eliminar..." class="form-control">
                                </div>
                        </form>
                ...
                <div>
                    ...
                    <br> 
                       <table border="3"  >
                       <legend class="text-center header">Listado de usuarios</legend>
                       <br> 
                       <hr>
		                        <thead>
			                            <tr>
