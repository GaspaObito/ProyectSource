...
<head>
    ...
    <title>ExprOut | Productos naturales </title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Tecnología: "El mundo cambio"</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
    ...
    <!-- Main content CARTAS DE primaryRMACIÓN INICIO-->
    <div class="content">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
